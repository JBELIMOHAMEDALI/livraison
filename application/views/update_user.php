			...
			<form class="needs-validation" method="post" action="<?= base_url('user/add_commande') ?>" novalidate>
				<div class="modal-body">
					<div class="form-group">
						...
						<input type="text" class="form-control" id="nom_rec" value="<?php echo $data_commande[0]->nom_rec?>" name="nom_rec" placeholder="First Name Receiver" required/>
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="prenom_rec" value="<?php echo $data_commande[0]->prenom_rec?>" name="prenom_rec" placeholder="Last Name Receiver" required/>
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="Region_rec" value="<?php echo $data_commande[0]->Region_rec?>" name="Region_rec" placeholder="Region Receiver" required/>
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="adresse_rec" value="<?php echo $data_commande[0]->adresse_rec?>" name="adresse_rec" placeholder="Address Receiver." required/>
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="telph_rec" value="<?php echo $data_commande[0]->telph_rec?>" name="telph_rec" placeholder="telph_rec" required/>
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" name="nom_art" value="<?php echo $data_commande[0]->nom_article?>" placeholder="Item Name" required/>
						<?php echo form_error('nom_art',' <div class="alert alert-danger" role="alert">','</div>') ?>
					</div>
					<div class="form-group">
						<label for="formGroupExampleInput2">Amount: *</label>
						<input type="text" class="form-control" id="qte" value="<?php echo $data_commande[0]->qte?>" name="qte" placeholder="amount" required/>
